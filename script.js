...
const app = Vue.createApp({
    setup() {
        ...
        const students = Vue.ref([
            { id: 1, name: '原梓杰', rank: 1, probability: 1 },
            { id: 2, name: '崔恒语', rank: 2, probability: 1 },
            { id: 3, name: '胡逸柯', rank: 3, probability: 1 },
            { id: 4, name: '邢任静', rank: 4, probability: 1 },
            { id: 5, name: '王铖浩', rank: 5, probability: 1 },
            { id: 6, name: '冯炜杰', rank: 6, probability: 1 },
            { id: 7, name: '李志敏', rank: 7, probability: 1 },
            { id: 8, name: '李梦雨', rank: 8, probability: 1 },
            { id: 9, name: '杜桓荣', rank: 9, probability: 1 },
            { id: 10, name: '原鑫椿', rank: 10, probability: 1 },
            { id: 11, name: '刘艺博', rank: 11, probability: 1 },
            { id: 12, name: '李怡萱', rank: 12, probability: 1 },
            { id: 13, name: '元静怡', rank: 13, probability: 1 },
            { id: 14, name: '李帅辉', rank: 14, probability: 1 },
            { id: 15, name: '茹柯臻', rank: 15, probability: 1 },
            { id: 16, name: '王彦景', rank: 16, probability: 1 },
            { id: 17, name: '马梓宁', rank: 17, probability: 1 },
            { id: 18, name: '焦雅琦', rank: 18, probability: 1 },
            { id: 19, name: '白淼鑫', rank: 19, probability: 1 },
            { id: 20, name: '史梓瑜', rank: 20, probability: 1 },
            { id: 21, name: '晋奥钊', rank: 21, probability: 1 },
            { id: 22, name: '王云鹏', rank: 22, probability: 1 },
            { id: 23, name: '段晶晶', rank: 23, probability: 1 },
            { id: 24, name: '张浩楠', rank: 24, probability: 1 },
            { id: 25, name: '成浩宇', rank: 25, probability: 1 },
            { id: 26, name: '马欣怡', rank: 26, probability: 1 },
            { id: 27, name: '樊师彤', rank: 27, probability: 1 },
            { id: 28, name: '王鹤凝', rank: 28, probability: 1 },
            { id: 29, name: '李湣帅', rank: 29, probability: 1 },
            { id: 30, name: '张祺曼', rank: 30, probability: 1 },
            { id: 31, name: '王沐勋', rank: 31, probability: 1 },
            { id: 32, name: '张艺瀚', rank: 32, probability: 1 },
            { id: 33, name: '原章恬', rank: 33, probability: 1 },
